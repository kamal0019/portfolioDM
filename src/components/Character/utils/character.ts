      ...
      try {
        ...
        loader.load(
          ...
          async (gltf) => {
            ...
            // Scale up generic model to match original custom model scale
            character.scale.set(10, 10, 10);
            character.position.y = -5; // Adjust vertical position
            ...
            character.traverse((child: any) => {
              if (child.isMesh) {
                ...
                // Removed explicit body/pant checks since model is generic
                // if (mesh.material) { ... }
